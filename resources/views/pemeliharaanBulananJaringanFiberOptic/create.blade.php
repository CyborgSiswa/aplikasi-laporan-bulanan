...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Bulanan Jaringan Fiber Optic</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanBulananJaringanFiberOptic.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pengecekan_join_closure" placeholder="pengecekan join closure"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan secara patroli fiber optic tanah:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_secara_patroli_fiber_optic_tanah" placeholder="pemeriksaan secara patroli fiber optic tanah"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
