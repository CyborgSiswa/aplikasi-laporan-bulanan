...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Wifi</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanWifi.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>periksa bandwith wifi :</strong>
                    <textarea class="form-control" style="height:150px" name="periksa_bandwidth_wifi" placeholder="periksa bandwith wifi"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
