...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Pendeteksi Metal Genggam</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanPendeteksiMetalGenggam.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_fungsi_switch_atau_tombol_on_off" placeholder="pemeriksaan fungsi switch atau tombol on off"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
