...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Bulanan Pabx</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanBulananPabx.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_terminal_terminal_pesawat_cabang" placeholder="pemeriksaan terminal terminal pesawat cabang"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan program operasi:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_program_operasi" placeholder="pemeriksaan program operasi"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
