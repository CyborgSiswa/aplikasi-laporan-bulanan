...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Harian Pabx</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanHarianPabx.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pembersihan_ruangan_sentral_operator" placeholder="pembersihan ruangan sentral operator "></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>periksa suhu dan kelembaban ruangan peralatan server pabx :</strong>
                    <textarea class="form-control" style="height:150px" name="periksa_suhu_dan_kelembaban_ruangan_peralatan_server_pabx" placeholder="periksa suhu dan kelembaban ruangan peralatan server pabx"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>periksa uji coba change over unit  :</strong>
                    <textarea class="form-control" style="height:150px" name="periksa_uji_coba_change_over_unit" placeholder="periksa uji coba change over unit"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
