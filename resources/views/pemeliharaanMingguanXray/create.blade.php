...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Xray</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanXray.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pembersihan_dan_pemeriksaan_light_barriers" placeholder="pembersihan dan pemeriksaan light barriers"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan protective earth writing :</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_protective_earth_wiring" placeholder="pemeriksaan protective earth writing"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan emergency stop switches:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_emergency_stop_switches" placeholder="pemeriksaan emergency stop switches"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
