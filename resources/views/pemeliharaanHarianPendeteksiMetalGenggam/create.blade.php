...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Harian Pendeteksi Metal Genggam</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{route('pemeliharaanHarianPendeteksiMetalGenggam.index')}}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('pemeliharaanHarianPendeteksiMetalGenggam.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan battery voltage :</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_battery_voltage" placeholder="pemeriksaan battery voltage""></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
