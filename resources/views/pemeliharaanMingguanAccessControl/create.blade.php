...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Access Control</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanAccessControl.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_fungsi_lock_door" placeholder="pemeriksaan fungsi lock door"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan buzzer :</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_buzzer" placeholder="pemeriksaan buzzer "></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
