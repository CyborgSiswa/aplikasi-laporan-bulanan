...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Bulanan Fids</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{route('pemeliharaanBulananFids.index')}}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('pemeliharaanBulananFids.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan access switch dan distribution switch:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_access_switch_dan_distribution_switch" placeholder="pemeriksaan access switch dan distribution switch"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
