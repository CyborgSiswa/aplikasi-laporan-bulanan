...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Fire Detection Alarm System</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanFireDetectionAlarmSystem.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_kabel_konektor_yang_terhubung_pada_mcfa" placeholder="pemeriksaan kabel konektor yang terhubung pada mcfa"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
