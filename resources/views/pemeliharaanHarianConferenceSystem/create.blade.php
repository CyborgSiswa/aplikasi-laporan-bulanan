...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Harian Conference System</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanHarianConferenceSystem.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="periksa_kondisi_fisik_microphone_dan_amplifier" placeholder="periksa kondisi fisik microphone dan amplifier"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>test output dari microphone:</strong>
                    <textarea class="form-control" style="height:150px" name="test_output_dari_microphone" placeholder="test output dari microphone"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
