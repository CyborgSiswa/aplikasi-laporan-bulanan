...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Bulanan Access Control</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanBulananAccessControl.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_fungsi_perangkat_pendeteksi_fingerprint_biometric" placeholder="pemeriksaan fungsi perangkat pendeteksi fingerprint biometric"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan fungsi emergency exit:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_fungsi_emergency_exit" placeholder="pemeriksaan fungsi emergency exit"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
