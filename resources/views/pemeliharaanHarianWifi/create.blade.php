...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Harian Wifi</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{route('pemeliharaanHarianWifi.index')}}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('pemeliharaanHarianWifi.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>periksa nyala lampu model dan access point :</strong>
                    <textarea class="form-control" style="height:150px" name="periksa_nyala_lampu_modem_dan_access_point" placeholder="periksa nyala lampu model dan access point"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>periksa ketersediaan ssid :</strong>
                    <textarea class="form-control" style="height:150px" name="periksa_ketersediaan_ssid" placeholder="periksa ketersediaan ssid"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
