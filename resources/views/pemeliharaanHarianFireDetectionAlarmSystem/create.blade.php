...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Harian Fire Detection Alarm System</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{route('pemeliharaanHarianFireDetectionAlarmSystem.index')}}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('pemeliharaanHarianFireDetectionAlarmSystem.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pembersihan lokasi sekitar mcfa:</strong>
                    <textarea class="form-control" style="height:150px" name="pembersihan_lokasi_sekitar_mcfa" placeholder="pembersihan lokasi sekitar mcfa"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>periksa suhu dan kelembaban ruangan peralatan:</strong>
                    <textarea class="form-control" style="height:150px" name="periksa_suhu_dan_kelembaban_ruangan_peralatan" placeholder="periksa suhu dan kelembaban ruangan peralatan"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>visual check tampilan layar control panel:</strong>
                    <textarea class="form-control" style="height:150px" name="visual_check_tampilan_layar_control_panel" placeholder="visual check tampilan layar control panel"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
