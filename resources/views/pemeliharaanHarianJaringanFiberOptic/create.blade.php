...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Harian Jaringan Fiber Optic</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanHarianJaringanFiberOptic.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="melakukan_test_ping_jaringan_kesetiap_perangkat_yang_terhubung" placeholder="melakukan test ping jaringan kesetiap perangkat yang terhubung"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
