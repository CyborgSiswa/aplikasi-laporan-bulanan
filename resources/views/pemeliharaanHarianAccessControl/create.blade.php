...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Harian Access Control</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{route('pemeliharaanHarianAccessControl.index')}}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('pemeliharaanHarianAccessControl.store')}}" method="POST">
        @csrf
        <div class="row">
