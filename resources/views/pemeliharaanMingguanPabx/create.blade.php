...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Pabx</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanPabx.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pembersihan_seluruh_head_set" placeholder="pembersihan seluruh head set"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong> pemeriksaan atau pengukuran voltage battery:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_atau_pengukuran_voltage_battery" placeholder="pemeriksaan atau pengukuran voltage battery"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
