...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Bulanan Gawang Pendeteksi Metal</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanBulananGawangPendeteksiMetal.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_interferensi_mekanikal" placeholder="pemeriksaan interferensi mekanikal"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan interferensi elektrikal:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_interferensi_elektrikal" placeholder="pemeriksaan interferensi elektrikal"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan tingkat sensitivitas:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_tingkat_sensitivitas" placeholder="pemeriksaan tingkat sensitivitas"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pengujian kinerja secara berkala dengan menggunakan otp:</strong>
                    <textarea class="form-control" style="height:150px" name="pengujian_kinerja_secara_berkala_dengan_menggunakan_otp" placeholder="pengujian kinerja secara berkala dengan menggunakan otp"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
