...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Tds</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanTds.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_power_supply_220_vac" placeholder="pemeriksaan power supply 220 vac"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan dan pembersihan konektor konektor :</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_dan_pembersihan_konektor_konektor" placeholder="pemeriksaan dan pembersihan konektor konektor"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan fungsi software tds :</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_fungsi_software_tds" placeholder="pemeriksaan fungsi software tds "></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
