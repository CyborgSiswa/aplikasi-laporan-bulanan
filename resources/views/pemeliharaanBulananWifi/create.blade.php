...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Bulanan Wifi</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanBulananWifi.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="periksa_kondisi_port_utp_kabel_pada_modem_dan_access_switch" placeholder="periksa kondisi port utp kabel pada modem dan access switch"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
