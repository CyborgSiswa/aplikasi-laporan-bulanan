...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Add Pemeliharaan Mingguan Gawang Pendeteksi Metal</h2>
            </div>
    ...
    <form action="{{route('pemeliharaanMingguanGawangPendeteksiMetal.store')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_alert_system_audible" placeholder="pemeriksaan alert system audible"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>pemeriksaan alert system visible:</strong>
                    <textarea class="form-control" style="height:150px" name="pemeriksaan_alert_system_visible" placeholder="pemeriksaan alert system visible"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
